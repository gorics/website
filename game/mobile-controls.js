(function () {
  ...
  function init() {
    ...
    function keyFromPoint(surface, clientX, clientY) {
      ...
      if (!opts.modes.includes('arrows')) return null;
      ...
      if (distance < opts.centerDeadZone) {
        return null;
      }
    ...
    function rememberTap(surface, clientX, clientY, tapMemory) {
    ...
    function handlePointerEvents(surface, pointerStates, tapMemory) {
      ...
      const endPointer = (e) => {
        ...
        if (e.pointerType === 'touch' || e.pointerType === 'pen') {
          rememberTap(surface, e.clientX, e.clientY, tapMemory);
        }
      };
    ...
    function setupGestureSurfaces() {
      ...
      surfaces.forEach((surface) => {
        handlePointerEvents(surface, pointerStates, tapMemory);
      });
    }
  }
